...
import com.vineetb.so.android.twitter.store.CredentialStore;
import com.vineetb.so.android.twitter.store.SharedPreferencesCredentialStore;
import com.vineetb.so.android.twitter.util.QueryStringParser;
	            		...
	            		try {
	            			...
	            			if (url.indexOf("oauth_token=")!=-1) {
		            			...
		            			CredentialStore credentialStore = new SharedPreferencesCredentialStore(prefs);
					  		      ...
					  		      startActivity(new Intent(OAuthAccessTokenActivity.this,AndroidTwitterActivity.class));
